      ...
      {isOpen && (
        <>
          ...
          <motion.aside
            ...
            className="fixed top-0 right-0 h-full w-full sm:w-[480px] bg-background border-l border-border/50 shadow-2xl z-[9999] flex flex-col"
          >
            <div className="flex items-center justify-between px-6 py-5 border-b border-border/40 bg-background/80 backdrop-blur-md sticky top-0 z-10">
              <div>
                ...
                <p className="text-xs font-medium text-muted-foreground uppercase tracking-wider mt-0.5">
                  {isLoading ? t("searching") : t("appsFound", { count: results.length })}
                </p>
              </div>
              <button
                onClick={onClose}
              ...
              {isLoading && (
                <div className="flex flex-col items-center justify-center h-64 space-y-6">
                  ...
                  <div className="text-center space-y-1">
                    <p className="text-foreground font-semibold">{t("loading.title")}</p>
